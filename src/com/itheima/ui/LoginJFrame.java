...
public class LoginJFrame extends JFrame implements MouseListener {
    //LoginJFrame表示登录界面,以后所有登录相关的代码，都写在这里
    ...
    //通过此方式访问到所有注册的用户的集合
    ArrayList<User> allUsers = RegisterJFrame.getMyStaticList();
    ...
    public void initView() {
        ...
        usernameText.setBounds(135, 139, 47, 17);
        ...
        passwordText.setBounds(150, 199, 32, 16);
